                            ...
                            <nav>
                                <ul id="menu-main-menu" class="menu">
                                    {{--<li id="menu-item-244" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-28 current_page_item menu-item-has-children menu-item-244">--}}
                                        ...
                                        {{--</ul>--}}
                                    {{--</li>--}}
                                    <li id="menu-item-279" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-279"><a href="{{URL::to('/courses.html')}}">Courses</a></li>
                                    <li id="menu-item-279" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-279"><a href="{{URL::to('/events.html')}}">Events</a></li>
                                    <li id="menu-item-243" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-243"><a href="{{URL::to('/about-us.html')}}">About Us</a></li>
